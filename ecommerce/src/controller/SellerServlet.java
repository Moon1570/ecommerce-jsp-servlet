...
public class SellerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("view")) {
			...
			request.setAttribute("seller", sellerModel);
			request.setAttribute("page", request.getParameter("page"));
			request.getRequestDispatcher("/update-seller.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("reg")) {
			...
			sellerModel.setSellerVillage(request.getParameter("sellerVillage"));
			sellerModel.setSellerHoldingNumber(request.getParameter("sellerHoldingNumber"));
			sellerModel.setSellerStreet(request.getParameter("sellerStreet"));
