	...
	<div class="container float-right mt-5"
		...
		<div class="table-responsive my-5">
			<form class="form-inline" method="post"
				action="./areas?action=updateupa&upaId=${upa.upazillaId}" id="form">
				<div class="form-group mx-sm-3 mb-2">
					<label for="exampleInputEmail1">
						<h4>Update Upazilla</h4> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					</label>
					<div class="form-group row">
						<div class="col-xs-2">
							<select name="divdd" class="form-control" required="required" id="divisionsDropDown" onchange="loadDistricts(this.value)">
								<option selected="selected" value="${upa.districtModel.divisionModel.divisionId }">${upa.districtModel.divisionModel.divisionBanglaName }</option>
						...
						<div class="col-xs-2 ml-5">
							...
							<option value="${upa.districtModel.districtId }" selected="selected">${upa.districtModel.districtBanglaName }</option>
								
							</select>
						</div>
						
						<div class="col-xs-2 ml-5">
							<input type="text" class="form-control" name="upaName" value="${upa.upazillaBangaName}" required="required"
