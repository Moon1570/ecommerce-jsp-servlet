		...
		<div class="side-bar">
			...
			<ul>
				...
				<li class="options-div" id="area"><a class="options"
					href="#area">Areas</a>
					<div class="sub-menu">
						<a href="./areas?action=divPage">Division</a> <a
							href="./areas?action=disPage">District</a> <a
							href="./areas?action=upaPage">Upazilla</a> <a
							href="./areas?action=uniPage">Union</a>
					</div></li>
									...
									.DataTable(
											{
												...
												ajax : {
													method : "GET",
													url : "./ordertable?action=getSellerOrders",
													dataSrc : "demo"
												},
												columns : [
														{
														...
														},
														{
															...
															"mRender" : function(
																	data, type,
																	full) {
																return '<a class="btn btn-outline-info btn-md" href=./orderoperations?action=viewsellerorder&page=admin&soid='
																		+ data.id
																		+ '>'
																		+ 'View'
																		+ '</a>'
