	...
	<div class="container float-right mt-5"
		...
		<div class="table-responsive my-5">
			<form class="form-inline" method="post"
				action="./areas?action=updateuni&uniId=${uni.unionId }" id="form">
					...
					<div class="form-group row">
						<div class="col-xs-2">
							<select name="divdd" class="form-control" required="required" id="divisionsDropDown" onchange="loadDistricts(this.value)">
								<option selected="selected" value="${uni.upazillaModel.districtModel.divisionModel.divisionId }">${uni.upazillaModel.districtModel.divisionModel.divisionBanglaName }</option>
						...
						<div class="col-xs-2 ml-4">
							...
							<option selected="selected" value="${uni.upazillaModel.districtModel.districtId }">${uni.upazillaModel.districtModel.districtBanglaName }</option>
								
							</select>
						</div>
						<div class="col-xs-2 ml-4">
							<select name="upadd" class="form-control" required="required" id="upazillasDropDown">
							<option selected="selected" value="${uni.upazillaModel.upazillaId }">${uni.upazillaModel.upazillaBangaName }</option>
								
							</select>
						</div>
						<div class="col-xs-2 ml-4">
							<input type="text" class="form-control" name="uniName" required="required"
