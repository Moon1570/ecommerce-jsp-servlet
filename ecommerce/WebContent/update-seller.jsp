		...
		<form action="./sellers" method="post" enctype="multipart/form-data">
			<div class="box">
					...
					<tr>
						<th colspan="2" rowsapn="2">
							<div class="table-header">
								<h3>Insert Seller Information</h3>
							</div>
						</th>
					</tr>
				<tr>
					<td>Seller First Name</td>
					<td><input type="text" name="sellerFirstName" required="required" value="${seller.sellerFirstName}"></td>
				</tr>
				
				<tr>
					<td>Seller Last Name</td>
					<td><input type="text" name="sellerLastName" required="required" value="${seller.sellerLastName}"></td>
				</tr>
				...
				<%
					...
					<tr>
						...
						<td><select class="input-field" id="divisionsDropDown" onchange="loadDistricts(this.value)"  name="sellerDivision" required="required">
								<option selected="selected" value="${seller.divisionmodel.divisionId}">${seller.divisionmodel.divisionBanglaName }</option>
					...
					<tr>
						...
						<td><select class="input-field" id="districtsDropDown" onchange="loadUpazillas(this.value)" name="sellerDistrict" required="required">
								<option selected="selected" value="${seller.districtModel.districtId}">${seller.districtModel.districtBanglaName }</option>
					...
					<tr>
						...
						<td><select class="input-field" name="sellerUpazilla" id="upazillasDropDown" onchange="loadUnions(this.value)" required="required">
							<option selected="selected" value="${seller.upazillaModel.upazillaId}">${seller.upazillaModel.upazillaBangaName }</option>
					...
					<tr>
						...
						<td><select class="input-field" id="unionsDropDown" name="sellerUnion" required="required">
								<option selected="selected" value="${seller.unionModel.unionId}">${seller.unionModel.unionBanglaName }</option>
				...
				<tr>
					...
					<td><input type="text" name="sellerPhone" required="required" value="${seller.sellerPhone }"></td>
				</tr>
				...
				<tr>
					<td>Seller Village</td>
					<td><input type="text" name="sellerVillage" required="required" value="${seller.sellerVillage }"></td>
				</tr>
				
				<tr>
					<td>Seller Street</td>
					<td><input type="text" name="sellerStreet" required="required" value="${seller.sellerStreet }"></td>
				</tr>
				
				<tr>
					<td>Seller Holding Number</td>
					<td><input type="text" name="sellerHoldingNumber" required="required" value="${seller.sellerHoldingNumber }"></td>
				</tr>
				
				<tr>
					<td>Seller NID</td>
					<td><input type="text" name="sellerNID" required="required" value="${seller.sellerNID }"></td>
				</tr>
				
				<tr>
					<td>Seller Gender</td>
					<td><select name="sellerGender" required="required">
						<option selected="selected" value="${seller.sellerGender }">${seller.sellerGender }</option>
					...
					<input type="hidden" value="${seller.sellerId }" name="sid">
