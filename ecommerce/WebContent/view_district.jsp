	...
	<div class="container float-right mt-5"
		...
		<div class="table-responsive my-5">
			<form class="form-inline" method="post"
				action="./areas?action=adddis" id="form">
				<div class="form-group mx-sm-3 mb-2">
					<label for="exampleInputEmail1">
						<h4>Add District</h4> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					</label>
					<div class="form-group row">
						<div class="col-xs-2">
							<select name="divisiondd" class="form-control">
								<c:forEach items="${divis }" var="divis">
									<option value="${divis.divisionId }" data-tokens="ketchup mustard">${divis.divisionBanglaName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="col-xs-2 ml-5">
							<input type="text" class="form-control" name="disName" required="required"
		...
		<div class="text-center">
			<h2 class="d-inline">District List</h2>
			<hr
			...
			<table id="myTable"
				...
				<thead class="thead-dark">
					<tr>
						...
						<th scope="col">Division ID & Name</th>
												...
												columns : [
														...
														},
														{
															...
															"mRender" : function(
																	data, type,
																	full) {
																return '<a class="btn btn-outline-info btn-md" href=./areas?action=updatedis&disId='
																		+ data.id
																		+ '>'
																		+ 'Edit'
																		+ '</a>   <a class="btn btn-outline-danger btn-md" href=./areas?action=deletedis&disId='
																		+ data.id
																		+ '>'
																		+ 'Delete'
																		+ '</a>';
