...
<body>
	...
	<div id="navbar">
		...
		<div class="menu-items">
			<a class="active" href="sad-index.jsp">Home</a> 
			<a
									...
									.DataTable(
											{
												...
												ajax : {
													method : "GET",
													url : "./ordertable?action=getSellerOrdersForSad",
													dataSrc : "demo"
												},
												columns : [
														{
														...
														},
														{
															...
															"mRender" : function(
																	data, type,
																	full) {
																return '<a class="btn btn-outline-info btn-md" href=./orderoperations?action=viewsellerorder&page=sad&soid='
																		+ data.id
																		+ '>'
																		+ 'View'
																		+ '</a>'
