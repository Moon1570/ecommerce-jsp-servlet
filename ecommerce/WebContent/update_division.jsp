	...
	<div class="container float-right mt-5"
		...
		<div class="table-responsive my-5">
			<form class="form-inline" method="post"
				action="./areas?action=updatediv&divId=${divi.divisionId }" id="form">
				<div class="form-group mx-sm-3 mb-2">
					<label for="exampleInputEmail1">
						<h4>Update Division</h4> &nbsp&nbsp
					</label> <input type="text" value="${divi.divisionBanglaName }" class="form-control" name="divName"
